...
STATUS_FILE = "/Users/greg/Code/turbo/status_simple.json"

# Auth from LATEST User curl
...
def run():
    ...
    # User asked for Sequential 16-connection download + extraction
    # Google indexes: 0, 1, 2
    for i in range(3):
        ...
        if proc.returncode != 0 or os.path.getsize(dest_path) < 100 * 1024 * 1024:
