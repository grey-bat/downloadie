...
# Auth details from your latest curl
...
def run():
    ...
    for i in range(3):
        ...
        if proc.returncode != 0 or not os.path.exists(dest_path) or os.path.getsize(dest_path) < 100 * 1024 * 1024:
